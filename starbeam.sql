...
CREATE TABLE `access`  (
  ...
  `module_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `action_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
CREATE TABLE `banner`  (
  ...
  `link` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '图片链接',
  `desc` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '图片描述',
  `createTime` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `shoot_id` int(10) NULL DEFAULT NULL COMMENT '关联的花絮id',
  `project_id` int(10) NULL DEFAULT NULL COMMENT '关联的项目id',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `SHOOT_BANNER`(`shoot_id`) USING BTREE,
  INDEX `PROJECT_BANNER`(`project_id`) USING BTREE,
...
CREATE TABLE `opus`  (
  ...
  `image_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '封面图',
  `video_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '视频链接',
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '标题',
  `sub_title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '副标题',
  `desc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '描述',
...
CREATE TABLE `project`  (
  ...
  `address` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '项目地址',
  `createTime` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `cid` int(10) NOT NULL COMMENT '分类id',
  `itemImg` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '图片地址',
  `itemTitle` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '项目标题',
  `itemSubTitle` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '项目副标题',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `PROJECT_CATEGORY`(`cid`) USING BTREE,
...
CREATE TABLE `projectcategory`  (
  ...
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '分类名',
  `desc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '分类描述',
  `small_img` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '封面图片',
  `cate_id` int(11) NOT NULL,
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '分类子标题',
  `subDesc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '分类副描述',
  `subTitle` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '分类子标题(英文)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `shoot`  (
  ...
  `createTime` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '标题·',
  `sub_title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '副标题',
  `desc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '描述',
  `small_img` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '小图片',
  PRIMARY KEY (`id`) USING BTREE
